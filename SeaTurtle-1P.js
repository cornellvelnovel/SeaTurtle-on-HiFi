...
function updateBody() {
    ...
    bodyRot = Quat.fromPitchYawRollRadians(0, Player1.bodyYaw(), 0);
    ...
    leftDeltaZ = leftPos1.z - leftPosLast1.z;
    rightDeltaZ = rightPos1.z - rightPosLast1.z;
...
function updateGame() {
    // Entities.editEntity(TURTLE_BODY_ID, {position: TURTLE_STARTING_POINT});
    updateBody();
